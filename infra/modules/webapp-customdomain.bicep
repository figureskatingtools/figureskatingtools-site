...
// certificate. Requires the DNS records to already exist (see dns.bicep —
// main.bicep orders these via dependsOn):
//   apex      -> A record to the inbound IP + `asuid` TXT
//   subdomain -> CNAME to the default hostname + `asuid.<label>` TXT
//
